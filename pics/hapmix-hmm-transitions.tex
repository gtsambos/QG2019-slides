...
\tikzset{inner sep=0mm,minimum width=3mm,minimum height=3mm,
...
% Focal sequence
\node (h0) {$\texttt{G}$};
\node (h1) [right=0mm of h0,node distance=0mm] {};
\node (h2) [right=0mm of h1] {};
\node (h3) [right=0mm of h2] {};
\node (h4) [right=0mm of h3] {};
\node (h5) [right=0mm of h4] {};
\node (h6) [right=0mm of h5] {};
\node (h7) [right=0mm of h6] {};
\node (h8) [right=0mm of h7] {};
\node (h9) [right=0mm of h8] {};
...
\node (chr2B1) at ($(h1) + (ref2) + (sam2)$) {};
\node (chr2B6) at ($(h6) + (ref2) + (sam2)$) {};
\node (chr2B7) at ($(h7) + (ref2) + (sam2)$) {\textcolor{white}{}};
