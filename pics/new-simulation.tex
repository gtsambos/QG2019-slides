...
% The time arrows
\draw[<->,line width=3pt] ($(mcra) - 2.5*(popsize)$) -- node[below,rotate=270] {\bf\tiny Backwards-in-time} ++($-2*(split-time)$)  --  node[below,rotate=270] {\bf\tiny Forwards-in-time} ++($-2*(split-time)$) ;
